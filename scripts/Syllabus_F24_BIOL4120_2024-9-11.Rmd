...
<img src="Header_BIOL4120.png" alt="BIOL 4120 Header Graphic" style="width:100%; height:auto;">
...
gtsave(learning.outcomes, "biol4120_learningoutcomes.html")
gtsave(learning.outcomes, "biol4120_learningoutcomes.png")
```
...
gtsave(grade.breakdown, "biol4120_gradebreakdown.html")
gtsave(grade.breakdown, "biol4120_gradebreakdown.png")
```
...
quiz.rubric <- tribble(
  ...
  tab_style(style = list(cell_fill(color  = "#CBB59340"),
                         ...
                         cell_text(color  = "#43475BFF",
                                   ...
                                   weight = "bold")),
            locations = cells_stub())
gtsave(quiz.rubric, "biol4120_quizrubric.html")
gtsave(quiz.rubric, "biol4120_quizrubric.png")
```
...
gtsave(class.culture, "classculture.html")
gtsave(class.culture, "classculture.png")
```
...
gt(rowname_col = "image") %>%
  ...
  cols_width(stub()   ~ px(50),
             Resource ~ px(100),
             Comment  ~ px(700))
gtsave(necessary.resources, paste0(params$local, "dataframes/biol4120_necessaryresources.html"))
gtsave(necessary.resources, paste0(params$local, "dataframes/biol4120_necessaryresources.png"))
```
...
<div class="float-box-p">
  <img src="conbiotext_cover.jpg" alt="Textbook Cover" class="info-box-image">
...
<img src="were-knee-deep-in-this-now-johnny.gif" alt="Knee Deep Schitt's Creek" class="gif-item"></img>
